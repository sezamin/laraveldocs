...
class Lessons
{
     ...
     * @var string
     */
    protected static $index_name = 'lessons';
    ...
    /**
     * Lesson files that should not be indexed.
     *
     * @var array
     */
    protected $noIndex = [
    ...
    {
        foreach (Lesson::getDocVersions() as $key => $title) {
    ...
    {
        $versionPath = base_path('resources/lessons/'.$version.'/');
    ...
    {
        $markdown = Lesson::replaceLinks($version, $this->files->get($path));
